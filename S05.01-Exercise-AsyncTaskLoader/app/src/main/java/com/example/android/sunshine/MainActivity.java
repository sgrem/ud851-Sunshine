...
// COMPLETED TODO (1) Implement the proper LoaderCallbacks interface and the methods of that interface
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final String WEATHER_LOCATION_EXTRA = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED TODO (7) Remove the code for the AsyncTask and initialize the AsyncTaskLoader
        /*
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        // COMPLETED TODO (2) Within onCreateLoader, return a new AsyncTaskLoader that looks a lot like the existing FetchWeatherTask.
        return new AsyncTaskLoader<String[]>(this) {
            // COMPLETED TODO (3) Cache the weather data in a member variable and deliver it in onStartLoading.
            private String[] mWeatherJson = null;
     ...
     */
    // COMPLETED TODO (4) When the load is finished, show either the data or an error message if there is no data
    @Override
    ...
    // COMPLETED TODO (6) Remove any and all code from MainActivity that references FetchWeatherTask
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // COMPLETED TODO (5) Refactor the refresh functionality to work with our AsyncTaskLoader
